...
### Trust Camouflage – Detection-Rule Leakage Framework
### Zot, M. (2026)
...
All studies reference TCFS v0.2 (Trust Camouflage Function Score – Coding Protocol v0.2 – pre-validation, research use only).
...
**Materials:**
- `H2_Therapeutic_Vocabulary_Accountability_Prereg_v3.md`
- `H2_vignette_stimuli_v3.csv` – 12 stems × 4 conditions = 48 stimuli
...
**Analysis:** One-way ANOVA, planned contrast Therapeutic_Mild vs Blunt, Holm-corrected; Jonckheere-Terpstra dose-response; mixed-effects robustness; ANCOVA with therapy_exposure + MH_literacy
...
**Materials:**
- `TCFS_coder_sheet_v0.2_corrected.csv`
...
- TCFS v0.2 is pre-validation research only – NOT a clinical instrument
